...
const Categories = () => {
    ...
    return (
        <div className="large__container relative pt-6 pb-10 xl:pt-12 xl:px-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 lg:gap-5 xl:gap-10">
